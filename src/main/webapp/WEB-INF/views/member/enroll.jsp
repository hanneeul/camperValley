...
4) 회원은 쿠키를 활용한 맞춤형 광고를 언제든지 차단할 수 있으며, 차단한 경우 더이상 맞춤형 광고가 노출되지 않습니다.
...
1) 휴대폰을 통한 결제 대행
- 수탁업체: (주) 다날
- 위탁업무 내용: 서비스 계약과 이용을 위한 결제 처리 및 결제 도용 방지
...
4) 상담을 위한 고객센터 툴(tool)
- 수탁업체: (주)굿텔레콤
- 위탁업무 내용: 문의 접수 및 처리를 위한 고객센터 tool 제공

5) 카카오 알림톡
- 수탁업체: ㈜ 카카오
- 위탁업무 내용: 결제 정보 제공, 비밀번호 변경 등 계정 상태의 변경 안내, 맞춤형 서비스 안내

6) 간편 결제를 통한 결제 대행
- 수탁업체: (주)카카오페이
- 위탁 업무 내용: 서비스 계약 이용을 위한 결제 처리 및 결제 도용 방지

7) 고객센터 운영 및 고객 서비스 상담
- 수탁업체: 주식회사 더블유서비시즈(주식회사 왓챠 자회사)
- 위탁 업무: 왓챠, 왓챠피디아 고객센터 운영 업무를 목적으로 청약 철회, 해지 예약, 탈퇴 진행 및 분실된 계정 조회 등 고객의 민원 처리
...
②  개인정보 처리 위탁 중 국외에서 처리하는 위탁업무는 아래와 같습니다.

1) 이전 받는 업체명 및 연락처: Zendesk Inc., (https://www.zendesk.com/contact/) 
- 이전되는 국가: 미국 
- 이전 일시 및 방법: 고객센터 이용 시점에 네트워크를 통한 전송 
- 이전되는 개인정보 항목: 이름, 이메일, 기기정보, 구독 상태, 문의 내용 
- 이전 받는 자의 이용 목적 및 보유∙이용 기간: 개인정보 보관 기간 동안 문의 응대

2) 이전 받는 업체명 및 연락처: The Rocket Science Group LLC (https://mailchimp.com/contact/) 
- 이전되는 국가: 미국 
- 이전 일시 및 방법: 서비스 이용 시점에 네트워크를 통한 전송 
- 이전되는 개인정보 항목: 닉네임, 이메일, 국가 
- 이전 받는 자의 이용 목적 및 보유∙이용 기간: 개인정보 보관 기간 동안 결제 등 안내 메일 발송
