	    ...
	    <div class="border-bottom mb-5 d-flex ">
		    ...
		    <div >
		        <div class="d-flex justify-content-between class="mt-3 mb-5">
                    ...
                    <div>
                        <br>
		                <button href="거래후기url" class="btn btn-success btn-sm align-self-center mr-3 d-block" >게시글 수정</button>
                        <br>
		                <button class="btn btn-outline-success btn-sm align-self-center mr-3 d-block" >삭제</button>
                    </div>
		        </div>
		        <hr />
			     <div class="d-flex justify-content-between class="mt-3 mb-5">
