	...
	<div class="container">
		...
		<div class="search-area">
		  ...
		  <sec:authorize access="!hasRole('BLACK') && isAuthenticated()">
			  <div class="ml-1">
				  <button type="button" id="enrollBtn" class="btn btn-success bg-camper-color" onclick="location.href='${pageContext.request.contextPath}/usedProduct/product/productEnroll'">글쓰기</button>
			  </div>
		  </sec:authorize>
		</div>
